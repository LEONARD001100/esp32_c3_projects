...
"<button onclick=\"setColor(255,0,0)\" style='background:red;color:white;padding:20px;margin:10px'>RED</button>"
"<button onclick=\"setColor(0,255,0)\" style='background:green;color:white;padding:20px;margin:10px'>GREEN</button>"
